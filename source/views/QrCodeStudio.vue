...
<template>
	...
	<div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
			...
			<div class="space-y-4">
				<div>
					...
					<div class="flex flex-wrap gap-2 mb-3">
						<button v-for="c in PRESET_COLORS" :key="c" @click="fgColor = c" :style="{ backgroundColor: c }"
							:class="[
				...
				<div>
					...
					<div class="flex flex-wrap gap-2">
						...
						<button @click="bgColor = '#ffffff'" :class="[
							...
							bgColor === '#ffffff' ? 'ring-2 ring-ring ring-offset-2' : 'border-input',
						]" />
						<button @click="bgColor = '#00000000'" :class="[
							'w-8 h-8 border rounded-md pattern-checkered-sm ring-offset-background',
							bgColor === '#00000000' ? 'ring-2 ring-ring ring-offset-2' : 'border-input',
						]" title="Transparent" />
		...
		<div class="order-1 lg:order-2 lg:col-span-7 flex flex-col items-center justify-center">
			...
			<p class="mt-4 sm:mt-6 text-[10px] sm:text-xs text-muted-foreground text-center max-w-sm px-4">
